							...
							<ul class="pagination">
								<c:if test="${pageMaker.prev}">
									<li class="page-item "><a class="page-link"
										href="<c:url value='/board/list?page=${pageMaker.startPage -1 }'/>"
								...
								<c:forEach begin="${pageMaker.startPage }"
									...
									<li
										...
										class="page-link"
										href="<c:url value='/board/list?page=${idx }'/>">${idx }</a></li>
								</c:forEach>
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li class="page-item"><a class="page-link"
										href="<c:url value='/board/list?page=${pageMaker.endPage +1}'/>">&raquo;</a>
									</li>
								</c:if>
