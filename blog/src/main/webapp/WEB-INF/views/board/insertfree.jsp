...
<form method = "post" name="form" onsubmit="return formCheck()">
...
<div class="form-group">
	...
	<input type="text" name="writer" class="form-control" value="${ login.id}" />
</div>
...
$(document).ready(function() {
	...
	function formCheck(){
	    ...
	    if (title == null || title == ""){                                    // null인지 비교한 뒤
	        ...
	        document.form.title.focus();                           // 해당태그에 포커스를 준뒤
	        return false;                                                     // false를 리턴합니다.
	    }
	    if (writer == null || writer == ""){                                    // null인지 비교한 뒤
	        alert('작성자를 입력하세요');                                   // 경고창을 띄우고
	        document.form.writer.focus();                           // 해당태그에 포커스를 준뒤
	        return false;                                                     // false를 리턴합니다.
	    }
	}
